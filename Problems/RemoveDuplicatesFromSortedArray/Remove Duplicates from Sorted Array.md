...
- Each time a unique element is on the second pointer, first pointer moves by 1 and changes it's element to unique one.
## Solution
...
## Reflections
- Rust STD can just dedup either way without creating new vector ...